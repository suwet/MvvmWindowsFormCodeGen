...
namespace Rmx.Views
{
    partial class EditC_ConfigForm
    {
        /// <summary>
        ...
        {
            this.gbx_editc_configform = new System.Windows.Forms.GroupBox();
 ...
 this.lbl_cf_description =  new System.Windows.Forms.Label();
            ...
            this.gbx_editc_configform.SuspendLayout();
            this.gbx_editc_configform.AutoSize = true;
            this.SuspendLayout();

            // add control to groupbox
 
               
 this.gbx_editc_configform.Controls.Add(this.txt_cf_name);
   
 this.gbx_editc_configform.Controls.Add(this.txt_cf_value);
   
 this.gbx_editc_configform.Controls.Add(this.txt_cf_group);
   
 this.gbx_editc_configform.Controls.Add(this.txt_cf_description);


               
 this.gbx_editc_configform.Controls.Add(this.lbl_cf_name);
   
 this.gbx_editc_configform.Controls.Add(this.lbl_cf_value);
   
 this.gbx_editc_configform.Controls.Add(this.lbl_cf_group);
   
 this.gbx_editc_configform.Controls.Add(this.lbl_cf_description);



            // setting goupbox
            this.gbx_editc_configform.Location = new System.Drawing.Point(12, 12);
            this.gbx_editc_configform.Name = "gbx_editc_configform";
            this.gbx_editc_configform.Size = new System.Drawing.Size(776, 372);
            this.gbx_editc_configform.TabIndex = 0;
            this.gbx_editc_configform.TabStop = false;
            this.gbx_editc_configform.Text = "editc_configform Information";
            // 
 ...
 this.lbl_cf_description.Text = "CF_Description";
            ...
            this.Controls.Add(this.gbx_editc_configform);
            this.Name = "EditMUserForm";
            this.Text = "MUserForm";
            this.AutoScroll = true;
            this.AutoSize = true;
            this.gbx_editc_configform.ResumeLayout(false);
            this.gbx_editc_configform.PerformLayout();
            this.ResumeLayout(false);
            this.PerformLayout();

            this.btn_save.Location = new System.Drawing.Point(247, this.gbx_editc_configform.Height+20);
            this.btn_cancel.Location = new System.Drawing.Point(418, this.gbx_editc_configform.Height+20);
        }

        #endregion

       
        private System.Windows.Forms.GroupBox gbx_editc_configform;
